...
print('Accuracy for Test Data on Spam Files based on Naive Bayes Model w/o stopwords: ' + str(spam_accuracy))
...
print('Accuracy for Test Data on Spam Files based on Logistic Regression with L2 Regularization w/o stopwrods: ' + str(
    spam_accuracy))
...
print('Accuracy for Test Data on Ham Files based on Naive Bayes Model w/o stopwords: ' + str(ham_accuracy))
...
spam_accuracy = evaluate(df_Logistic_X, df_Logistic_Y, final_theta)
print('Accuracy for Test Data on Ham Files based on Logistic Regression with L2 Regularization w/o stopwords: ' + str(
    spam_accuracy))
